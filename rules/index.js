...
Rules.prototype.switchPlayer = function () {
    this.currentPlayerColor = this.color[this.currentPlayerColor];
}

//adds coords
Rules.prototype.addCoords = function (board, addingCoord) {
...
Rules.prototype.findCluster = function (destination, addingCoord) {
...
Rules.prototype.combineClusters = function (destination, indexesOfClusters) {
...
Rules.prototype.checkNearestCoords = function (addingCoord, currentCluster) {
...
Rules.prototype.checkClosure = function (board, indexOfCluster) {
    ...
    for (var i = 0; i < suspiciousCoords.length; i++) {
        ...
        this.checkSides(currentStone, suspiciousCoords, surroundedCoords, board, indexOfCluster, maxX, maxY);
    }
...
Rules.prototype.checkSides = function (currentStone, suspiciousCoords, surroundedCoords, board, indexOfCluster, maxX, maxY) {
    var color = this.currentPlayerColor;
...
Rules.prototype.isStoneAdded = function (checkingCoords, surroundedCoords) {
...
Rules.prototype.isSurroundedCoordsExist = function (surroundedCoords, board, enemyColor) {
...
Rules.prototype.deleteCoords = function (surrounded, board, enemyColor) {
...
//repeat!!!
Rules.prototype.addSurroundedCoords = function (surroundedCoords, addingCoord) {
...
//finds cluster to add coords
Rules.prototype.findSurroundedCluster = function (destination, addingCoord) {
    var indexesOfClusters = []; //indexes of clusters that are near the current stone 
...
//checks if there are stones near current point
Rules.prototype.checkNearestSurroundedCoords = function (addingCoord, currentCluster) {
    for (var i = -1; i <= 1; i++) {
        for (var j = -1; j <= 1; j++) {
